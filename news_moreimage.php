      ...
      <form id="jvalidate" name="frmGallery" role="form" class="form-horizontal" action="#" method="post"
        ...
        <div class="box-footer text-right">
          ...
          <button class="btn btn-default waves-effect " type="reset"
            onClick="javascript:funCancel('frmGallery','jvalidate','gallerymoretimage','newsevents_mng.php');">Cancel</button>
          <button class="btn btn-primary waves-effect waves-light m-l-5" id="submit-form" type="button"
            onClick="javascript:funSubmtWithImg('frmGallery','newsevents_actions.php','jvalidate','gallerymoretimage','news_moreimage.php?id=<?php echo $view; ?>');"><span
