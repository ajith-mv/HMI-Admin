         ...
         <div class="box-body">
                 ...
                 <!--  <div class="form-group" id="photos">
                  ...
                  <div class="box-footer text-right">
                    ...
                    <button class="btn btn-default waves-effect " type="reset" onClick="javascript:funCancel('frmGallery','jvalidate','gallerymoretimage','newsevents_mng.php');" >Cancel</button>
					<button class="btn btn-primary waves-effect waves-light m-l-5" id="submit-form"   type="button" onClick="javascript:funSubmtWithImg('frmGallery','newsevents_actions.php','jvalidate','gallerymoretimage','news_moreimage.php?id=<?php echo $view;?>');" ><span id="spSubmit"><i class="fa fa-save"></i>  save <?php echo $btn; ?></span></button>
                 </div><!-- /.box-footer -->
                   </form>
...
-->   				<div class="box">
                  ...
                  <table id="tblresult" class="table  table-striped">
                    ...
                    <tr class="odd gradeX">
                            <td><?php echo $j;?></td>
                             ...
                             <td> 
                           		<input type="hidden" name="productimgid" id="productimgid<?php echo $getimg['moreimgid'];?>" value="<?php echo $getimg1['moreimgid'];?>" />
                                <input type="text"   name="image1title<?php echo $getimg['moreimgid'];?>" id="image1title<?php echo $getimg['moreimgid'];?>" placeholder="Image Sort order" class="form-control" value="<?=$getimg['imagetitle']?>"  />
                             </td>  
                             
                             
                             <td> 
                           		<input type="hidden" name="productimgid" id="productimgid<?php echo $getimg['moreimgid'];?>" value="<?php echo $getimg1['moreimgid'];?>" />
                               <input type="text"   maxlength="3" onkeypress="return CheckNumericKeyInfowithoutDot(event.keyCode, event.which);" name="image1order<?php echo $getimg['moreimgid'];?>" id="image1order<?php echo $getimg['moreimgid'];?>" placeholder="Image Sort order" class="form-control" value="<?=$getimg['imgorder']?>"  />
                             </td>                                            
                            
                            <td align="center">
                              <input name="status<?php echo $getimg['moreimgid'];?>" <?php if($getimg['isactive']==1){echo $check="checked";} ?> id="modules-<?php echo $getimg['moreimgid'];?>" value="1" type="checkbox">
                              <input type="hidden" name="image<?php echo $getimg['moreimgid'];?>id" id="image<?php echo $getimg['moreimgid'];?>id" placeholder="Image Sort order" class="form-control" value="<?=$getimg['moreimgid']?>" />
                            </td>
                          ...
                          <td class="center">   
                             ...
                             <input type="hidden" name="productim<?php echo $getimg['moreimgid'];?>" value="<?php echo $getimg['imgname']; ?>" />
                             <input name="imgname<?php echo $getimg['moreimgid'];?>" value="<?php echo root; ?>uploads/newsevents/<?php echo $getimg['imgname']; ?>" type="hidden">                    
                          </td>
                       </tr>                    
                    <?php $j++;}?>                                           
                    <?php
          ...
          <?php if($countgetimages > 0){?>
            ...
            <div class="col-md-12 text-right">
                   ...
                   <button class="btn bg-grey margin" type="reset" onClick="javascript:funCancel('noimg','jvalidate1','moreimageupdate','newsevents_mng.php');" >Cancel</button>
       <!-- <input type="submit" class="btn bg-maroon margin pull-right" value="Update" />-->
                <button class="btn btn-success waves-effect waves-light " type="button" onClick="javascript:funSubmt('noimg','newsevents_actions.php','jvalidate1','moreimageupdate','news_moreimage.php?id=<?php echo $view;?>');" >
