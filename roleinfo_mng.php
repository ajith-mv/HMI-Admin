  ...
  <div class="container"> 
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="btn-group pull-right m-t-15"> <a href="roleinfo_form.php" class="btn btn-custom dropdown-toggle waves-effect waves-light">Add Role <span class="m-l-5"><i class="fa fa-plus"></i></span></a> </div>
        <?php }?>
