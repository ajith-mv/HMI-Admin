      ...
      <form id="jvalidate" name="frmGallery" role="form" class="form-horizontal" action="#" method="post"
        ...
        <div class="box-footer text-right">
          ...
          <button class="btn btn-default waves-effect " type="reset"
            onClick="javascript:funCancel('frmGallery','jvalidate','gallerymoretimage','gallery_mng.php');">Cancel</button>
          <button class="btn btn-primary waves-effect waves-light m-l-5" id="submit-form" type="button"
            onClick="javascript:funSubmtWithImg('frmGallery','gallery_actions.php','jvalidate','gallerymoretimage','gallery_moreimage.php?id=<?php echo $view; ?>');"><span
                ...
                if ($countgetimages > 0) {
                  ...
                  foreach ($getallimg as $getimg) {
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td>
                        <input type="hidden" name="productimgid" id="productimgid<?php echo $getimg['glyimgid']; ?>"
                          value="<?php echo $getimg1['glyimgid']; ?>" />
                        <input type="text" name="image1title<?php echo $getimg['glyimgid']; ?>"
                          id="image1title<?php echo $getimg['glyimgid']; ?>" placeholder="Image Sort order"
                          class="form-control" value="<?= $getimg['imgtitle'] ?>" required />
                      </td>
                      ...
                      <td>
                        ...
                        <input type="text" maxlength="3"
                          ...
                          name="image1order<?php echo $getimg['glyimgid']; ?>"
                          id="image1order<?php echo $getimg['glyimgid']; ?>" placeholder="Image Sort order"
                          class="form-control" value="<?= $getimg['imgorder'] ?>" required />
                      </td>

                      <td align="center">
                        <input name="status<?php echo $getimg['glyimgid']; ?>" <?php if ($getimg['isactive'] == 1) {
                             echo $check = "checked";
                           } ?> id="modules-<?php echo $getimg['glyimgid']; ?>" value="1" type="checkbox">
                        <input type="hidden" name="image<?php echo $getimg['glyimgid']; ?>id"
                          id="image<?php echo $getimg['glyimgid']; ?>id" placeholder="Image Sort order" class="form-control"
                          value="<?= $getimg['glyimgid'] ?>" />
                      </td>
                      ...
                      <td class="center">
                        ...
                        <input type="hidden" name="productim<?php echo $getimg['glyimgid']; ?>"
                          value="<?php echo $getimg['imgname']; ?>" />
                        <input name="imgname<?php echo $getimg['glyimgid']; ?>"
                          value="<?php echo root; ?>uploads/gallery/<?php echo $getimg['imgname']; ?>" type="hidden">
                      </td>
                    </tr>
                    <?php $j++;
                  } ?>
    ...
    $("#gallerymoreimage").filer({
      ...
      templates: {
        ...
        onSelect: function (files) {
          if ($("#gallerymoreimage")[0].files.length > 12) {
