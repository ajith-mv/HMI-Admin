              ...
              <div class="col-lg-8 m-t-20">
                <form id="jvalidate" name="frmnewsevents" role="form" class="form-horizontal" action="#" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <div class="pad-tb-7">
                        <input type="checkbox" data-plugin="switchery" value=<?php echo ($res_ed['isactive'] == 0) ? '0' : '1'; ?> name="chkstatus" id="chkstatus" data-color="#00b19d" data-size="small" <?php echo $chk; ?> />
                      </div>
                    </div>
                  </div>
